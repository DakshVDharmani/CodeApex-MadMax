class DomainRouter:
    def route(self, claim_text, entity_info):
        ...
        # news / current events
        if any(k in text for k in ["conflict", "talks", "blocked", "spikes", "economic", "political", "election", "protest", "summit", "negotiations", "diplomatic", "government", "officials", "announced", "military", "sanctions"]):
            return ["news"]
